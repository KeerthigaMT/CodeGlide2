...
func Get_repositories_workspace_repo_slug_refs_tagsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repositories/%s/%s/refs/tags%s", cfg.BaseURL, queryString)
...
func CreateGet_repositories_workspace_repo_slug_refs_tagsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_workspace_repo_slug_refs_tags",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_repositories_workspace_repo_slug_refs_tagsHandler(cfg),
	}
}
