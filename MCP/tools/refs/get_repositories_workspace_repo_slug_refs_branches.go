...
func Get_repositories_workspace_repo_slug_refs_branchesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repositories/%s/%s/refs/branches%s", cfg.BaseURL, queryString)
		...
		var result models.Paginatedbranches
...
func CreateGet_repositories_workspace_repo_slug_refs_branchesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_workspace_repo_slug_refs_branches",
		mcp.WithDescription("List open branches"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_repositories_workspace_repo_slug_refs_branchesHandler(cfg),
	}
}
