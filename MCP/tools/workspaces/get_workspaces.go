...
func Get_workspacesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Paginatedworkspaces
...
func CreateGet_workspacesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_workspaces",
		mcp.WithDescription("List workspaces for user"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_workspacesHandler(cfg),
	}
}
