...
func Post_repositories_workspace_repo_slug_commit_commit_statuses_buildHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repositories/%s/%s/commit/%s/statuses/build", cfg.BaseURL)
...
func CreatePost_repositories_workspace_repo_slug_commit_commit_statuses_buildTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_repositories_workspace_repo_slug_commit_commit_statuses_build",
		mcp.WithDescription("Create a build status for a commit"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_repositories_workspace_repo_slug_commit_commit_statuses_buildHandler(cfg),
	}
}
