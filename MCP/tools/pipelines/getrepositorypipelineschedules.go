...
func GetrepositorypipelineschedulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Paginatedpipelineschedules
...
func CreateGetrepositorypipelineschedulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_workspace_repo_slug_pipelines_config_schedules",
		mcp.WithDescription("List schedules"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetrepositorypipelineschedulesHandler(cfg),
	}
}
