...
func GetpipelinevariablesforuserHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetpipelinevariablesforuserTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_users_selected_user_pipelines_config_variables",
		mcp.WithDescription("List variables for a user"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetpipelinevariablesforuserHandler(cfg),
	}
}
