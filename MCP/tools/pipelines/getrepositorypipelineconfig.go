...
func GetrepositorypipelineconfigHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetrepositorypipelineconfigTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_workspace_repo_slug_pipelines_config",
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetrepositorypipelineconfigHandler(cfg),
	}
}
