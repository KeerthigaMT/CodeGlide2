...
func GetpipelinevariablesforworkspaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetpipelinevariablesforworkspaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_workspaces_workspace_pipelines-config_variables",
		mcp.WithDescription("List variables for a workspace"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetpipelinevariablesforworkspaceHandler(cfg),
	}
}
