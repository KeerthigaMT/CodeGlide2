...
func CreatepipelinevariableforteamHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatepipelinevariableforteamTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_teams_username_pipelines_config_variables",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatepipelinevariableforteamHandler(cfg),
	}
}
