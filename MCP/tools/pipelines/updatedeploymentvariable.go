...
func UpdatedeploymentvariableHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUpdatedeploymentvariableTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_repositories_workspace_repo_slug_deployments_config_environments_environment_uuid_variables_variable_uuid",
		mcp.WithDescription("Update a variable for an environment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdatedeploymentvariableHandler(cfg),
	}
}
