...
func GetdeploymentvariablesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Paginateddeploymentvariable
...
func CreateGetdeploymentvariablesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_workspace_repo_slug_deployments_config_environments_environment_uuid_variables",
		mcp.WithDescription("List variables for an environment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetdeploymentvariablesHandler(cfg),
	}
}
