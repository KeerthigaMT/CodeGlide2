...
func GetpipelinevariableforworkspaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetpipelinevariableforworkspaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_workspaces_workspace_pipelines-config_variables_variable_uuid",
		mcp.WithDescription("Get variable for a workspace"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetpipelinevariableforworkspaceHandler(cfg),
	}
}
