...
func CreaterepositorypipelineknownhostHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreaterepositorypipelineknownhostTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_repositories_workspace_repo_slug_pipelines_config_ssh_known_hosts",
		mcp.WithDescription("Create a known host"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreaterepositorypipelineknownhostHandler(cfg),
	}
}
