...
func GetpipelinevariableforteamHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetpipelinevariableforteamTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_teams_username_pipelines_config_variables_variable_uuid",
		mcp.WithDescription("Get a variable for a team"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetpipelinevariableforteamHandler(cfg),
	}
}
