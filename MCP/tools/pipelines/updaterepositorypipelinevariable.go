...
func UpdaterepositorypipelinevariableHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repositories/%s/%s/pipelines_config/variables/%s", cfg.BaseURL, workspace, repo_slug, variable_uuid)
...
func CreateUpdaterepositorypipelinevariableTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_repositories_workspace_repo_slug_pipelines_config_variables_variable_uuid",
		mcp.WithDescription("Update a variable for a repository"),
		...
		mcp.WithString("variable_uuid", mcp.Required(), mcp.Description("The UUID of the variable to update.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdaterepositorypipelinevariableHandler(cfg),
	}
}
