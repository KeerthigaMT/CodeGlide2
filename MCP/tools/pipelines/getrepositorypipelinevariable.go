...
func GetrepositorypipelinevariableHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetrepositorypipelinevariableTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_workspace_repo_slug_pipelines_config_variables_variable_uuid",
		mcp.WithDescription("Get a variable for a repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetrepositorypipelinevariableHandler(cfg),
	}
}
