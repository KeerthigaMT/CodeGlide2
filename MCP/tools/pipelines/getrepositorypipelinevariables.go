...
func GetrepositorypipelinevariablesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repositories/%s/%s/pipelines_config/variables", cfg.BaseURL, workspace, repo_slug)
		...
		var result models.Paginatedpipelinevariables
...
func CreateGetrepositorypipelinevariablesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_workspace_repo_slug_pipelines_config_variables",
		mcp.WithDescription("List variables for a repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetrepositorypipelinevariablesHandler(cfg),
	}
}
