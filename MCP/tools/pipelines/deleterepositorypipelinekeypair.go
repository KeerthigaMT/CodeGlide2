...
func DeleterepositorypipelinekeypairHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleterepositorypipelinekeypairTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repositories_workspace_repo_slug_pipelines_config_ssh_key_pair",
		mcp.WithDescription("Delete SSH key pair"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleterepositorypipelinekeypairHandler(cfg),
	}
}
