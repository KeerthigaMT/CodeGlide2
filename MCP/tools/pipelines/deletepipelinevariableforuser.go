...
func DeletepipelinevariableforuserHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletepipelinevariableforuserTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_users_selected_user_pipelines_config_variables_variable_uuid",
		mcp.WithDescription("Delete a variable for a user"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletepipelinevariableforuserHandler(cfg),
	}
}
