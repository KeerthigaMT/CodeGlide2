...
func GetrepositorypipelineknownhostsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repositories/%s/%s/pipelines_config/ssh/known_hosts", cfg.BaseURL, workspace, repo_slug)
		...
		var result models.Paginatedpipelineknownhosts
...
func CreateGetrepositorypipelineknownhostsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_workspace_repo_slug_pipelines_config_ssh_known_hosts",
		mcp.WithDescription("List known hosts"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetrepositorypipelineknownhostsHandler(cfg),
	}
}
