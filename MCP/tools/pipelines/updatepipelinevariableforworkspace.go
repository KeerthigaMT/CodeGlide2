...
func UpdatepipelinevariableforworkspaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUpdatepipelinevariableforworkspaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_workspaces_workspace_pipelines-config_variables_variable_uuid",
		mcp.WithDescription("Update variable for a workspace"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdatepipelinevariableforworkspaceHandler(cfg),
	}
}
