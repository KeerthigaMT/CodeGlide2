...
func CreaterepositorypipelinevariableHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreaterepositorypipelinevariableTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_repositories_workspace_repo_slug_pipelines_config_variables",
		mcp.WithDescription("Create a variable for a repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreaterepositorypipelinevariableHandler(cfg),
	}
}
