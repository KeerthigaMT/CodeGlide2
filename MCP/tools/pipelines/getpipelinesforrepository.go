...
func GetpipelinesforrepositoryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Paginatedpipelines
...
func CreateGetpipelinesforrepositoryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_workspace_repo_slug_pipelines",
		mcp.WithDescription("List pipelines"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetpipelinesforrepositoryHandler(cfg),
	}
}
