...
func GetrepositorypipelinesshkeypairHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetrepositorypipelinesshkeypairTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_workspace_repo_slug_pipelines_config_ssh_key_pair",
		mcp.WithDescription("Get SSH key pair"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetrepositorypipelinesshkeypairHandler(cfg),
	}
}
