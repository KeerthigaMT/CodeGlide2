...
func CreatedeploymentvariableHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Deploymentvariable
		...
		url := fmt.Sprintf("%s/repositories/%s/%s/deployments_config/environments/%s/variables", cfg.BaseURL, workspace, repo_slug, environment_uuid)
		...
		var result models.Deploymentvariable
...
func CreateCreatedeploymentvariableTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_repositories_workspace_repo_slug_deployments_config_environments_environment_uuid_variables",
		mcp.WithDescription("Create a variable for an environment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatedeploymentvariableHandler(cfg),
	}
}
