...
func BulkcreateorupdateannotationsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody []Reportannotation
...
func CreateBulkcreateorupdateannotationsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_repositories_workspace_repo_slug_commit_commit_reports_reportId_annotations",
		mcp.WithDescription("Bulk create or update annotations"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    BulkcreateorupdateannotationsHandler(cfg),
	}
}
