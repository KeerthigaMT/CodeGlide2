...
func DeletereportHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletereportTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repositories_workspace_repo_slug_commit_commit_reports_reportId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletereportHandler(cfg),
	}
}
