...
func GetreportsforcommitHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repositories/%s/%s/commit/%s/reports", cfg.BaseURL, workspace, repo_slug, commit)
		...
		var result models.Paginatedreports
...
func CreateGetreportsforcommitTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_workspace_repo_slug_commit_commit_reports",
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetreportsforcommitHandler(cfg),
	}
}
