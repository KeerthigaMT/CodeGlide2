...
func GetannotationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetannotationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_workspace_repo_slug_commit_commit_reports_reportId_annotations_annotationId",
		mcp.WithDescription("Get an annotation"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetannotationHandler(cfg),
	}
}
