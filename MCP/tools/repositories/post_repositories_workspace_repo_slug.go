...
func Post_repositories_workspace_repo_slugHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_repositories_workspace_repo_slugTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_repositories_workspace_repo_slug",
		mcp.WithDescription("Create a repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_repositories_workspace_repo_slugHandler(cfg),
	}
}
