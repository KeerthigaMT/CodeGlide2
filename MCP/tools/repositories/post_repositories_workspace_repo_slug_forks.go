...
func Post_repositories_workspace_repo_slug_forksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repositories/%s/%s/forks", cfg.BaseURL)
...
func CreatePost_repositories_workspace_repo_slug_forksTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_repositories_workspace_repo_slug_forks",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_repositories_workspace_repo_slug_forksHandler(cfg),
	}
}
