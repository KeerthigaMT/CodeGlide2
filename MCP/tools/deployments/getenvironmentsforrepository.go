...
func GetenvironmentsforrepositoryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repositories/%s/%s/environments", cfg.BaseURL, workspace, repo_slug)
		...
		var result models.Paginatedenvironments
...
func CreateGetenvironmentsforrepositoryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_workspace_repo_slug_environments",
		mcp.WithDescription("List environments"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetenvironmentsforrepositoryHandler(cfg),
	}
}
