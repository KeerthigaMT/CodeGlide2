...
func CreateenvironmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Deploymentenvironment
...
func CreateCreateenvironmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_repositories_workspace_repo_slug_environments",
		mcp.WithDescription("Create an environment"),
		...
		mcp.WithString("name", mcp.Description("Input parameter: The name of the environment.")),
		mcp.WithString("uuid", mcp.Description("Input parameter: The UUID identifying the environment.")),
	)
