...
func DeleteenvironmentforrepositoryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteenvironmentforrepositoryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repositories_workspace_repo_slug_environments_environment_uuid",
		mcp.WithDescription("Delete an environment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteenvironmentforrepositoryHandler(cfg),
	}
}
