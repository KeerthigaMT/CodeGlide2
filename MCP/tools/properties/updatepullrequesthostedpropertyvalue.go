...
func UpdatepullrequesthostedpropertyvalueHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUpdatepullrequesthostedpropertyvalueTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_repositories_workspace_repo_slug_pullrequests_pullrequest_id_properties_app_key_property_name",
		mcp.WithDescription("Update a pull request application property"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdatepullrequesthostedpropertyvalueHandler(cfg),
	}
}
