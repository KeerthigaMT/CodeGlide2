...
func GetpullrequesthostedpropertyvalueHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetpullrequesthostedpropertyvalueTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_workspace_repo_slug_pullrequests_pullrequest_id_properties_app_key_property_name",
		mcp.WithDescription("Get a pull request application property"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetpullrequesthostedpropertyvalueHandler(cfg),
	}
}
