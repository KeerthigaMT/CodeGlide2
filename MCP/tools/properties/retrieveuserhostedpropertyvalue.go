...
func RetrieveuserhostedpropertyvalueHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRetrieveuserhostedpropertyvalueTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_users_selected_user_properties_app_key_property_name",
		mcp.WithDescription("Get a user application property"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    RetrieveuserhostedpropertyvalueHandler(cfg),
	}
}
