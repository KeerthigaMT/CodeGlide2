...
func DeleterepositoryhostedpropertyvalueHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleterepositoryhostedpropertyvalueTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repositories_workspace_repo_slug_properties_app_key_property_name",
		mcp.WithDescription("Delete a repository application property"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleterepositoryhostedpropertyvalueHandler(cfg),
	}
}
