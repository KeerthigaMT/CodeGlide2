...
func UpdateuserhostedpropertyvalueHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUpdateuserhostedpropertyvalueTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_users_selected_user_properties_app_key_property_name",
		mcp.WithDescription("Update a user application property"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateuserhostedpropertyvalueHandler(cfg),
	}
}
