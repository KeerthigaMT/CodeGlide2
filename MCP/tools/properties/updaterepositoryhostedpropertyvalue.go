...
func UpdaterepositoryhostedpropertyvalueHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUpdaterepositoryhostedpropertyvalueTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_repositories_workspace_repo_slug_properties_app_key_property_name",
		mcp.WithDescription("Update a repository application property"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdaterepositoryhostedpropertyvalueHandler(cfg),
	}
}
