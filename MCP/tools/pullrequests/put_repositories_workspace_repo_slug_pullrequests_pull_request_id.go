...
func Put_repositories_workspace_repo_slug_pullrequests_pull_request_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_repositories_workspace_repo_slug_pullrequests_pull_request_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_repositories_workspace_repo_slug_pullrequests_pull_request_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_repositories_workspace_repo_slug_pullrequests_pull_request_idHandler(cfg),
	}
}
